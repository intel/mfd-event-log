...
# MFD Event Log documentation build configuration file, created by
...
htmlhelp_basename = "mfd_event_log"
...
man_pages = [(master_doc, "mfd_event_log", "MFD Event Log Documentation", [author], 1)]
